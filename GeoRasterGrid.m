    ...
    methods
        ...
        function ax = show(this, ax)
            ...
            if isempty(ax.Children)
                ...
                % need to adjust edges by 1/2 cell (1/2 pixel)
                dx = 360 / size(earth_texture, 2);
                dy = 180 / size(earth_texture, 1);

                image(...
                    linspace((-180+dx/2),(180-dx/2), size(earth_texture,2)), ...
                    linspace((90-dy/2),(-90+dy/2), size(earth_texture,1)), ...
                    earth_texture, ...
                    'parent', ax)
